...
export default function WhoAmI() {
  ...
  return (
    <section id="who" className="who">
      ...
      <div className="section who-inner" ref={proxRef}>
        <Reveal stagger={0.16}>
        ...
        <Reveal className="who-body" stagger={0.3} duration={0.9} start="top 78%">
          ...
          <p>
            <VariableProximity text="一个 29 岁，定居东京的女生。" containerRef={proxRef} />
          </p>
          <p>
          ...
          <p>
            <VariableProximity
              text="一个觉得创造是人生的大救赎，并且期望通过创造能为他人的世界带来一点改变的理想主义者。"
              containerRef={proxRef}
            />
          </p>
          <p>
            <VariableProximity
              text="一个做项目是为了留住点什么的，希望冰冷的代码生出温暖的意义的践行者。"
              containerRef={proxRef}
            />
          </p>
        </Reveal>
